...
<script lang="ts">
	...
	name: "Dario Amodei",
	role: "Co-founder & CEO",
	image: "/generated/image-a-headshot-of-a-thoughtful-founder-in-a-.webp"
};
</script>
...
<section bind:this={sectionRef} {...props}>
	<div class="section-px section-py container mx-auto">
        ...
        text={`"We started Anthropic because we weren’t satisfied with building just intelligent systems—we wanted to build responsible ones."`}
    />
